...
namespace PoeHUD.Poe.RemoteMemoryObjects
{
	public class IngameUIElements : RemoteMemoryObject
	{
		...
		public Element QuestTracker => ReadObjectAt<Element>(0xC60+0x8);
		public Element OpenLeftPanel => ReadObjectAt<Element>(0xCA0 + 0x8);
		public Element OpenRightPanel => ReadObjectAt<Element>(0xCA8 + 0x8);
		public InventoryElement InventoryPanel => ReadObjectAt<InventoryElement>(0xCD8 + 0x8);
		public Element TreePanel => ReadObjectAt<Element>(0xD08 + 0x8);
		public Element AtlasPanel => ReadObjectAt<Element>(0xD10 + 0x8);
		public Map Map => ReadObjectAt<Map>(0xD60 + 0x8);
		public IEnumerable<ItemsOnGroundLabelElement> ItemsOnGroundLabels
		{
			get
			{
				var itemsOnGroundLabelRoot = ReadObjectAt<ItemsOnGroundLabelElement>(0xD68 + 0x8);
				return itemsOnGroundLabelRoot.Children;
			}
		}
		public Element GemLvlUpPanel => ReadObjectAt<Element>(0xFF0 + 0x8);
		public ItemOnGroundTooltip ItemOnGroundTooltip => ReadObjectAt<ItemOnGroundTooltip>(0x1060 + 0x8);
