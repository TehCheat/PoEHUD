...
namespace PoeHUD.Poe.RemoteMemoryObjects
{
    public class IngameUIElements : RemoteMemoryObject
    {
        ...
        public Element QuestTracker => ReadObjectAt<Element>(0xC50 + 0x8);
        public Element OpenLeftPanel => ReadObjectAt<Element>(0xC90 + 0x8);
        public Element OpenRightPanel => ReadObjectAt<Element>(0xC98 + 0x8);
        public InventoryElement InventoryPanel => ReadObjectAt<InventoryElement>(0xCC8 + 0x8);
        public Element TreePanel => ReadObjectAt<Element>(0xCF8 + 0x8);
        public Element AtlasPanel => ReadObjectAt<Element>(0xD00 + 0x8);
        public Map Map => ReadObjectAt<Map>(0xD50 + 0x8);
        public IEnumerable<ItemsOnGroundLabelElement> ItemsOnGroundLabels
        {
            get
            {
                var itemsOnGroundLabelRoot = ReadObjectAt<ItemsOnGroundLabelElement>(0xD58 + 0x8);
                return itemsOnGroundLabelRoot.Children;
            }
        }
        public Element GemLvlUpPanel => ReadObjectAt<Element>(0xFA8 + 0x8);
        public ItemOnGroundTooltip ItemOnGroundTooltip => ReadObjectAt<ItemOnGroundTooltip>(0x1018 + 0x8);

        public bool IsDndEnabled => M.ReadByte(Address + 0xf92 + 0x8) == 1;
        public string DndMessage => M.ReadStringU(M.ReadLong(Address + 0xf98 + 0x8));
        ...
        public List<Tuple<Quest, int>> GetUncompletedQuests
        {
            get
            {
                var stateListPres = M.ReadDoublePointerIntList(M.ReadLong(Address + 0x9e0 + 0x8));
